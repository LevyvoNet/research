...
class HeuristicsTest(unittest.TestCase):
    def test_dijkstra_simple_env(self):
        ...
        vi_policy = ValueIterationPolicy(env, 1.0).train()
    ...
    def test_dijkstra_sum_sanity_room_env_large_goal_reward(self):
        ...
        vi_policy0 = PrioritizedValueIterationPolicy(env0, 1.0).train()
        vi_policy1 = PrioritizedValueIterationPolicy(env1, 1.0).train()
    ...
    def test_pvi_min_sanity_env_large_goal_reward(self):
        ...
        vi_policy = [PrioritizedValueIterationPolicy(envs[i], 1.0).train() for i in range(env.n_agents)]
